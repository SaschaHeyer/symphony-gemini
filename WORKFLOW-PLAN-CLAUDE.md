...
Always use the Linear MCP tools for ALL Linear operations.

- To transition issue states: use the Linear MCP server to update issues with the issue ID and state name (e.g., "Plan Review", "In Progress").
- To manage comments: use the Linear MCP server to list, create, and update comments.
